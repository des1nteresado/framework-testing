...
public class MainPage {
    ...
    public Button afisha = new Button(By.xpath(convertToUtf("(//a[contains(text(),'Афиша кинотеатров')])[2]")),"afisha button");
    ...
    public Button top250 = new Button(By.xpath(convertToUtf("(//a[contains(text(),'Топ 250')])[2]")),"afisha button");
